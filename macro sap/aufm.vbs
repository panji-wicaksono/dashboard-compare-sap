...
session.findById("wnd[1]/usr/ctxtRLGRAP-FILENAME").text = "C:\Users\USER\Documents\01 Work\CPI\02 Learning\06 Development\dashboard-compare-sap\data upload\aufm.xls"
session.findById("wnd[1]/usr/ctxtRLGRAP-FILENAME").caretPosition = 106
